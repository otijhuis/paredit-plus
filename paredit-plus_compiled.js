...
var G__13387__delegate = function (ed,locs){return cljs.core.apply.call(null,f,cljs.core.map.call(null,(function (p1__13305_SHARP_){return lt.objs.editor.pos__GT_index.call(null,ed,p1__13305_SHARP_);
}),locs));
};
var G__13387 = function (ed,var_args){
var locs = null;if (arguments.length > 1) {
  locs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__13387__delegate.call(this,ed,locs);};
G__13387.cljs$lang$maxFixedArity = 1;
G__13387.cljs$lang$applyTo = (function (arglist__13388){
var ed = cljs.core.first(arglist__13388);
var locs = cljs.core.rest(arglist__13388);
return G__13387__delegate(ed,locs);
});
...
var vec__13307 = cljs.core.juxt.call(null,new cljs.core.Keyword(null,"ch","ch",1013907415),new cljs.core.Keyword(null,"line","line",1017226086)).call(null,loc__$1);var ch = cljs.core.nth.call(null,vec__13307,0,null);var line = cljs.core.nth.call(null,vec__13307,1,null);var c = lt.plugins.paredit_plus.char_at_loc.call(null,ed,loc__$1);if((ch < 0))
{return cljs.core.odd_QMARK_.call(null,result);
} else
{if(cljs.core._EQ_.call(null,"\\",c))
{{
var G__13389 = lt.objs.editor.adjust_loc.call(null,loc__$1,-1);
var G__13390 = (result + 1);
loc__$1 = G__13389;
result = G__13390;
continue;
}
...
{var pred__13311 = cljs.core._EQ_;var expr__13312 = dir;if(cljs.core.truth_(pred__13311.call(null,new cljs.core.Keyword(null,"backward","backward",3135881045),expr__13312)))
{return loc;
} else
{if(cljs.core.truth_(pred__13311.call(null,new cljs.core.Keyword(null,"forward","forward",4631725623),expr__13312)))
{return lt.objs.editor.adjust_loc.call(null,loc,-1);
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__13312)].join('')));
}
}
} else
{{
var G__13391 = next_loc;
var G__13392 = loc;
loc = G__13391;
result = G__13392;
continue;
...
{return cljs.core.first.call(null,cljs.core.remove.call(null,(function (p1__13314_SHARP_){return cljs.core._EQ_.call(null,l,p1__13314_SHARP_);
...
{var vec__13316 = cljs.core.first.call(null,chars);var char$ = cljs.core.nth.call(null,vec__13316,0,null);var loc = cljs.core.nth.call(null,vec__13316,1,null);if(cljs.core._EQ_.call(null,loc,l))
{{
var G__13393 = cljs.core.rest.call(null,chars);
var G__13394 = stack;
chars = G__13393;
stack = G__13394;
continue;
...
{{
var G__13395 = cljs.core.rest.call(null,chars);
var G__13396 = (stack + 1);
chars = G__13395;
stack = G__13396;
continue;
}
...
{{
var G__13397 = cljs.core.rest.call(null,chars);
var G__13398 = (stack - 1);
chars = G__13397;
stack = G__13398;
continue;
}
...
{{
var G__13399 = cljs.core.rest.call(null,chars);
var G__13400 = stack;
chars = G__13399;
stack = G__13400;
continue;
...
;
lt.plugins.paredit_plus.locate_chars_on_line = (function locate_chars_on_line(ed,l,cs,dir){return cljs.core.take_while.call(null,(function (p__13319){var vec__13320 = p__13319;var c = cljs.core.nth.call(null,vec__13320,0,null);var loc = cljs.core.nth.call(null,vec__13320,1,null);return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"line","line",1017226086).cljs$core$IFn$_invoke$arity$1(l),new cljs.core.Keyword(null,"line","line",1017226086).cljs$core$IFn$_invoke$arity$1(loc));
...
var find_unbalanced__3 = (function (ed,l,dir){var cs = (function (){var pred__13325 = cljs.core._EQ_;var expr__13326 = dir;if(cljs.core.truth_(pred__13325.call(null,new cljs.core.Keyword(null,"forward","forward",4631725623),expr__13326)))
{return lt.plugins.paredit_plus.pair_chars.call(null,new cljs.core.Keyword(null,"close","close",1108660586));
} else
{if(cljs.core.truth_(pred__13325.call(null,new cljs.core.Keyword(null,"backward","backward",3135881045),expr__13326)))
{return lt.plugins.paredit_plus.pair_chars.call(null,new cljs.core.Keyword(null,"open","open",1017321916));
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__13326)].join('')));
}
}
...
{var vec__13328 = cljs.core.first.call(null,locations);var c = cljs.core.nth.call(null,vec__13328,0,null);var loc = cljs.core.nth.call(null,vec__13328,1,null);var temp__4090__auto__ = lt.plugins.paredit_plus.find_match.call(null,ed,loc,c);if(cljs.core.truth_(temp__4090__auto__))
...
{var vec__13330 = temp__4092__auto__;var c = cljs.core.nth.call(null,vec__13330,0,null);var loc = cljs.core.nth.call(null,vec__13330,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [lt.plugins.paredit_plus.find_match.call(null,ed,loc,c),loc], null);
} else
{return null;
}
});
...
{var vec__13332 = temp__4092__auto__;var startloc = cljs.core.nth.call(null,vec__13332,0,null);var endloc = cljs.core.nth.call(null,vec__13332,1,null);var adjustment = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"before","before",3915985649),0,new cljs.core.Keyword(null,"after","after",1106639182),1], null);var dir__GT_loc = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"forward","forward",4631725623),endloc,new cljs.core.Keyword(null,"backward","backward",3135881045),startloc], null);return lt.objs.editor.move_cursor.call(null,ed,lt.objs.editor.adjust_loc.call(null,dir__GT_loc.call(null,dir),side.call(null,adjustment)));
} else
{return null;
}
});
...
return (function (p__13343){var vec__13344 = p__13343;var c__$1 = cljs.core.nth.call(null,vec__13344,0,null);var loc = cljs.core.nth.call(null,vec__13344,1,null);return cljs.core._EQ_.call(null,line,new cljs.core.Keyword(null,"line","line",1017226086).cljs$core$IFn$_invoke$arity$1(loc));
});})(line))
...
{var temp__4090__auto__ = cljs.core.some.call(null,(function (p__13345){var vec__13346 = p__13345;var c__$1 = cljs.core.nth.call(null,vec__13346,0,null);var loc = cljs.core.nth.call(null,vec__13346,1,null);var temp__4092__auto__ = lt.plugins.paredit_plus.find_match.call(null,ed,loc,c__$1);if(cljs.core.truth_(temp__4092__auto__))
...
}),cljs.core.filter.call(null,(function (p__13347){var vec__13348 = p__13347;var c__$1 = cljs.core.nth.call(null,vec__13348,0,null);var _ = cljs.core.nth.call(null,vec__13348,1,null);return cljs.core.contains_QMARK_.call(null,lt.plugins.paredit_plus.pair_chars.call(null,new cljs.core.Keyword(null,"close","close",1108660586)),c__$1);
...
{var temp__4090__auto____$1 = cljs.core.some.call(null,(function (p__13349){var vec__13350 = p__13349;var c__$1 = cljs.core.nth.call(null,vec__13350,0,null);var loc = cljs.core.nth.call(null,vec__13350,1,null);var temp__4092__auto__ = lt.plugins.paredit_plus.find_match.call(null,ed,loc,c__$1);if(cljs.core.truth_(temp__4092__auto__))
...
}),cljs.core.filter.call(null,(function (p__13351){var vec__13352 = p__13351;var c__$1 = cljs.core.nth.call(null,vec__13352,0,null);var _ = cljs.core.nth.call(null,vec__13352,1,null);return cljs.core.contains_QMARK_.call(null,lt.plugins.paredit_plus.pair_chars.call(null,new cljs.core.Keyword(null,"open","open",1017321916)),c__$1);
...
var wrap_region__3 = (function (ed,p__13353,p){var vec__13357 = p__13353;var startloc = cljs.core.nth.call(null,vec__13357,0,null);var endloc = cljs.core.nth.call(null,vec__13357,1,null);return wrap_region.call(null,ed,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [startloc,endloc], null),p,false);
});
var wrap_region__4 = (function (ed,p__13354,p,end_inclusive_QMARK_){var vec__13358 = p__13354;var startloc = cljs.core.nth.call(null,vec__13358,0,null);var endloc = cljs.core.nth.call(null,vec__13358,1,null);return lt.objs.editor.operation.call(null,ed,(function (){lt.objs.editor.replace.call(null,ed,lt.objs.editor.adjust_loc.call(null,endloc,(cljs.core.truth_(end_inclusive_QMARK_)?1:0)),new cljs.core.Keyword(null,"close","close",1108660586).cljs$core$IFn$_invoke$arity$1(p));
...
wrap_region = function(ed,p__13354,p,end_inclusive_QMARK_){
switch(arguments.length){
case 3:
return wrap_region__3.call(this,ed,p__13354,p);
case 4:
return wrap_region__4.call(this,ed,p__13354,p,end_inclusive_QMARK_);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
{var mloc = temp__4092__auto__;return lt.plugins.paredit_plus.wrap_region.call(null,ed,cljs.core.sort_by.call(null,(function (p1__13359_SHARP_){return lt.objs.editor.pos__GT_index.call(null,ed,p1__13359_SHARP_);
...
{var vec__13361 = temp__4092__auto__;var c = cljs.core.nth.call(null,vec__13361,0,null);var loc = cljs.core.nth.call(null,vec__13361,1,null);var temp__4092__auto____$1 = lt.plugins.paredit_plus.find_match.call(null,ed,loc,c);if(cljs.core.truth_(temp__4092__auto____$1))
...
{var vec__13366 = temp__4092__auto__;var c = cljs.core.nth.call(null,vec__13366,0,null);var loc = cljs.core.nth.call(null,vec__13366,1,null);var temp__4092__auto____$1 = lt.plugins.paredit_plus.find_match.call(null,ed,loc,c);if(cljs.core.truth_(temp__4092__auto____$1))
{var mloc = temp__4092__auto____$1;var pred__13367 = cljs.core._EQ_;var expr__13368 = dir;if(cljs.core.truth_(pred__13367.call(null,new cljs.core.Keyword(null,"backward","backward",3135881045),expr__13368)))
...
{if(cljs.core.truth_(pred__13367.call(null,new cljs.core.Keyword(null,"forward","forward",4631725623),expr__13368)))
...
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__13368)].join('')));
}
}
} else
{return null;
...
{var vec__13371 = temp__4092__auto__;var c = cljs.core.nth.call(null,vec__13371,0,null);var loc = cljs.core.nth.call(null,vec__13371,1,null);if(cljs.core.truth_(lt.plugins.paredit_plus.find_match.call(null,ed,loc,c)))
...
lt.plugins.paredit_plus.paredit_join_sexps = (function paredit_join_sexps(ed,l){var vec__13374 = cljs.core.first.call(null,lt.plugins.paredit_plus.locate_chars.call(null,ed,l,lt.plugins.paredit_plus.pair_chars.call(null,new cljs.core.Keyword(null,"close","close",1108660586)),new cljs.core.Keyword(null,"backward","backward",3135881045)));var lc = cljs.core.nth.call(null,vec__13374,0,null);var ll = cljs.core.nth.call(null,vec__13374,1,null);var vec__13375 = cljs.core.first.call(null,lt.plugins.paredit_plus.locate_chars.call(null,ed,l,lt.plugins.paredit_plus.pair_chars.call(null,new cljs.core.Keyword(null,"open","open",1017321916)),new cljs.core.Keyword(null,"forward","forward",4631725623)));var rc = cljs.core.nth.call(null,vec__13375,0,null);var rl = cljs.core.nth.call(null,vec__13375,1,null);if(cljs.core.truth_((function (){var and__7799__auto__ = lc;if(cljs.core.truth_(and__7799__auto__))
{return rc;
} else
{return and__7799__auto__;
}
...
if(!(cljs.core.empty_QMARK_.call(null,chars)))
{var vec__13377 = cljs.core.first.call(null,chars);var c = cljs.core.nth.call(null,vec__13377,0,null);var loc = cljs.core.nth.call(null,vec__13377,1,null);var temp__4092__auto__ = lt.plugins.paredit_plus.find_match.call(null,ed,loc,c);if(cljs.core.truth_(temp__4092__auto__))
...
{{
var G__13401 = mloc;
var G__13402 = lt.plugins.paredit_plus.locate_chars_on_line.call(null,ed,mloc,all_pair_chars,new cljs.core.Keyword(null,"forward","forward",4631725623));
startloc__$1 = G__13401;
chars = G__13402;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{{
var G__13403 = startloc__$1;
var G__13404 = cljs.core.rest.call(null,chars);
startloc__$1 = G__13403;
chars = G__13404;
continue;
}
} else
...
{var vec__13379 = temp__4092__auto__;var start = cljs.core.nth.call(null,vec__13379,0,null);var end = cljs.core.nth.call(null,vec__13379,1,null);return lt.objs.editor.replace.call(null,ed,lt.objs.editor.adjust_loc.call(null,start,1),end,"");
} else
{return null;
}
});
...
return (function (p__13384){var vec__13385 = p__13384;var startloc = cljs.core.nth.call(null,vec__13385,0,null);var endloc = cljs.core.nth.call(null,vec__13385,1,null);var temp__4092__auto__ = lt.plugins.paredit_plus.pair_bounds.call(null,ed,startloc);if(cljs.core.truth_(temp__4092__auto__))
{var vec__13386 = temp__4092__auto__;var p_startloc = cljs.core.nth.call(null,vec__13386,0,null);var p_endloc = cljs.core.nth.call(null,vec__13386,1,null);return lt.objs.editor.operation.call(null,ed,((function (ed,l,vec__13386,p_startloc,p_endloc,temp__4092__auto__,vec__13385,startloc,endloc,c,token,tokentype){
...
});})(ed,l,vec__13386,p_startloc,p_endloc,temp__4092__auto__,vec__13385,startloc,endloc,c,token,tokentype))
);
} else
{return null;
}
...
return (function (p1__13380_SHARP_){return lt.objs.editor.pos__GT_index.call(null,ed,p1__13380_SHARP_);
});})(ed,l))
